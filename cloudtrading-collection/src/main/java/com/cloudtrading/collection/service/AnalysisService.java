...
import com.cloudtrading.analysis.utils.AgAnalyse;
import com.cloudtrading.analysis.utils.AreaAnalyse;
...
public class AnalysisService {
	...
	public JsonUnitData analysisGoldCopper12_24(Long time9,Long time430) throws ServiceException, IOException, AWTException{
		...
		AgAnalyse goldcopperAnalyse=
				new AgAnalyse(production);
		//alllist.addAll(list);
	...
	public JsonUnitData analysisSilveralloy12_8(Long time9,Long time430) throws ServiceException, IOException, AWTException{
		...
		int marginalValue=9;
		GoldCopperAnalyse silveralloyAnalyse=
				new GoldCopperAnalyse(production,marginalValue,SilverAlloy.stopPoint1);
		//alllist.addAll(list);
	...
	public JsonUnitData analysisGoldCopper12_15(Long time9,Long time430) throws ServiceException, IOException, AWTException{
		StringBuffer sql=new StringBuffer();
		List<Object> queryParams = new ArrayList<Object>();
		...
		AreaAnalyse areaAnalyse=
				new AreaAnalyse(production,100,100);
		//alllist.addAll(list);
		for(GoldCopperData value:list){
			areaAnalyse.readPosition(new Position(value.getVALUE(),value.getTIME()));
		}
		String result=areaAnalyse.printCalculateResult();
	...
	public JsonUnitData analysisGoldCopper12_8(Long time9,Long time430) throws ServiceException, IOException, AWTException{
		...
		Production production=new Production("中金云", "银基合金", 2, period);
		int marginalValue=6;  //3时 概率大于0.6 有0.8 1.0 情况，但一日成交量小于4
		GoldCopperAnalyse goldcopperAnalyse=
				new GoldCopperAnalyse(production,marginalValue,GoldCopper.stopPoint1);
		//alllist.addAll(list);
		for(GoldCopperData value:list){
			goldcopperAnalyse.readPosition(new Position(value.getVALUE(),value.getTIME()));
		}
	...
	public JsonUnitData analysisCorundum12_8(Long time9,Long time430) throws ServiceException, IOException, AWTException{
		...
		int marginalValue=8;
		GoldCopperAnalyse corundumAnalyse=
				new GoldCopperAnalyse(production,marginalValue,Corundum.stopPoint1);
		//alllist.addAll(list);
